...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
      ...
      <div class="row mt-3">
        <div class="col mb-3">
            <h3 class="text-center" style="color:#02487a;">Manage Authors</h3>
        </div>
      </div>
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="" class="form-label " style="color:#0f74bc;">Author Name</label>
                    <input type="text" placeholder="Title" autocomplete="off" class="form-control" runat="server" id="ANameTb"/>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label " style="color:#0f74bc;">Author Gender</label>
                ...
                <div class="mb-3">
                    <label for="" class="form-label " style="color:#0f74bc;">Country</label>
