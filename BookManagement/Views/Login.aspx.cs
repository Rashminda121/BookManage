...
namespace BookManagement.Views
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void loginBtn_Click(object sender, EventArgs e)
        {
            ...
            else if(username.Value=="admin@mail.com" && password.Value=="admin"){

                Response.Redirect("Admin/Books.aspx");
            }
            else
            {
                string query = "select bid as Code,bname as Name,bqty as Stock,bprice as Price   from seller where semail='{0}' and spass='{1}'";
